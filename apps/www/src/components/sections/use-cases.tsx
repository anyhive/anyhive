  ...
  const logs = [
    {
      ...
      message: "Checkout session created (psp=payuni, currency=TWD).",
      icon: (
        <div className="h-8 w-8 rounded-full bg-blue-500 flex items-center justify-center">
    ...
    },
    {
      ...
      message: "Router selected PSP 'stripe' for subscription.",
      icon: (
        <div className="h-8 w-8 rounded-full bg-green-500 flex items-center justify-center">
          <DatabaseIcon className="h-5 w-5 text-white" />
        </div>
    ...
    },
    {
      ...
      message: "Usage event aggregated (feature=api_calls, window=hour).",
      icon: (
        <div className="h-8 w-8 rounded-full bg-purple-500 flex items-center justify-center">
    ...
    },
    {
      ...
      message: "Payment requires 3DS; customer action sent.",
      icon: (
    ...
    },
    {
      ...
      message: "Webhook signature verified; event deduplicated.",
      icon: (
