...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        // Fallback (unprefixed) + prefixed (moneta:) utilities
        "fixed inset-0 z-50 bg-black/50 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 moneta:fixed moneta:inset-0 moneta:z-50 moneta:bg-black/50 moneta:data-[state=open]:animate-in moneta:data-[state=closed]:animate-out moneta:data-[state=closed]:fade-out-0 moneta:data-[state=open]:fade-in-0",
        className
      )}
      {...props}
    />
      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="ring-offset-background focus:ring-ring data-[state=open]:bg-accent data-[state=open]:text-muted-foreground absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none moneta:ring-offset-background moneta:focus:ring-ring moneta:data-[state=open]:bg-accent moneta:data-[state=open]:text-muted-foreground moneta:absolute moneta:top-4 moneta:right-4 moneta:rounded-xs moneta:opacity-70 moneta:transition-opacity moneta:hover:opacity-100 moneta:focus:ring-2 moneta:focus:ring-offset-2 moneta:focus:outline-hidden moneta:disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
          >
            <XIcon />
